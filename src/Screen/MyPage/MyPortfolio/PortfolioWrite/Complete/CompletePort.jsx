...
const CompletePort = () =>{
    return(
        <div className={styles.CompletePort}>
            <RouteName route={route}/>

            {/* 사이드 네비게이터 + 컨텐츠*/}
            <div className={styles.CompletePort__wrap}>
                ...
                <div className={styles.CompletePort__contentWrap}>
                    ...
                    {/*AI로 생성된 포폴 */}
                    <div className= {styles.CompletePort__content}>
                    </div>
                    <div className={styles.CompletePort__saveBtn}><Button text='저장' /></div>
                </div>
            </div>
