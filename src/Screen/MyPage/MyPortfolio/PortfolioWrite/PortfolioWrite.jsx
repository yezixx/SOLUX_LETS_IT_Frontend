...
const PortfolioWrite = ()=>{
    return(
        <div className={styles.portfolioWrite}>
            <RouteName route={route}/>
            <div className={styles.portfolioWrite__wrap}>
                ...
                <div className={styles.portfolioWrite__contentWrap}>
                    ...
                    {/*프로젝트명 */}
                    <h3 className={styles.portfolioWrite__title}>
                    OPEN AI 활용 프로젝트
                    </h3>

                    {/*포트폴리오 작성 폼 */}
                    <form className={styles.portfolioWrite__form}>
                        <input className={styles.portfolioWrite__form__title} placeholder='제목을 입력하세요'></input>

                        <label htmlFor='role'>담당역할
                            <FormInput placeholder='백엔드'/>
                        </label>

                        <label htmlFor='stack'>사용스택
