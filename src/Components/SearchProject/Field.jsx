...
const Field = () => {
    ...
    return (
        ...
        <div><h1 className={styles.title}>개발 분야</h1>
        <div className={styles.nav__searchBar_container}>
                ...
                <div className={styles.button}><Stackblist buttons={f} /></div>
                
                </div>
                
                <div><h1 className={styles.title}>필요 스택</h1>
        <div className={styles.nav__searchBar_container}>
                    <div className={styles.nav__searchBar}>
                    <input
                        className={styles.nav__searchbar_input}
                ...
                <div className={styles.button}><Stackblist buttons={s} /></div>
                <div className={styles.searchb}><Button text="검색" height="40px"
